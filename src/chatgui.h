...
private:
    ...
    std::unique_ptr<ChatLogic> _chatLogic;// Changed from raw pointer to unique pointer
...
public:
    ...
    // getter / setter
    ChatLogic *GetChatLogicHandle() { return _chatLogic.get();} //Changed so that the raw pointer is sent
